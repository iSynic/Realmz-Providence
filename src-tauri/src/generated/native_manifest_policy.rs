...
pub const REALMZ_NATIVE_LAYOUT: RealmzNativeLayout = RealmzNativeLayout {
    ...
    scenario_shell_bytes: 316,
    scenario_support_file_bytes: 600,
    scenario_contact_info_bytes: 4608,
    scenario_restrictions_bytes: 320,
    global_macro_hook_bytes: 60,
    land_layout_rows: 8,
    land_layout_columns: 16,
    land_layout_cell_bytes: 2,
    land_layout_bytes: 256,
    tile_solids_bytes: 1024,
    mapstats_record_bytes: 40,
    mapstats_records: 201,
    landlook_range_header_bytes: 4,
    landlook_range_tail_bytes: 60,
    landlook_range_slot_bytes: 6,
    landlook_range_slots: 10,
    custom_landlook_metadata_bytes: 8104,
