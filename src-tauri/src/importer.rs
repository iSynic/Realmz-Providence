...
struct ProjectFile<'a> {
    ...
    authoring_target: crate::project::AuthoringTarget,
    remake_runtime: &'a RemakeRuntime,
    maps: &'a [MapEntity],
...
impl<'a> From<&'a ProvidenceProject> for ProjectFile<'a> {
    fn from(project: &'a ProvidenceProject) -> Self {
        Self {
            ...
            authoring_target: project.authoring_target,
            remake_runtime: &project.remake_runtime,
            maps: &project.maps,
