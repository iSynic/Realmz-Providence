...
use record_bytes::{
    copy_fixed_bytes, copy_raw, decode_pascal_text, encode_pascal_text, fallback_i8, i32_be,
    parse_fixed_records, pascal_record_string, preserve_raw, provenance, read_i16_array,
    read_i16_vec, read_i32_vec, signed_bytes, write_fixed_records, write_i16_array, write_i16_vec,
    write_i32_be, write_i32_vec, write_i8_array,
};
...
mod tests {
    ...
    fn target_records_round_trip_full_records() {
        let cases: [(usize, fn(&[u8]) -> Vec<u8>); 9] = [
            (MESSAGE_BYTES, |bytes| {
