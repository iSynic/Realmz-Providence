...
use crate::realmz::{
    ...
    RANDLEVEL_BYTES, SIMPLE_ENCOUNTER_BYTES,
};
...
pub(super) fn source_anchors() -> Vec<SemanticEvidence> {
    vec![
        SemanticEvidence {
            ...
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\format-index.md".to_string(),
        ...
        SemanticEvidence {
            ...
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\semantic-schema.md".to_string(),
            note: "Source/record/entity/link/evidence/diagnostic model.".to_string(),
        },
        SemanticEvidence {
            id: "anchor:fixtures".to_string(),
            confidence: Confidence::FixtureBacked,
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\fixtures.md".to_string(),
        ...
        SemanticEvidence {
            ...
            confidence: Confidence::SourceBacked,
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\runtime-consumer-matrix.md".to_string(),
        ...
        SemanticEvidence {
            ...
            confidence: Confidence::SourceBacked,
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\opcode-runtime-reference.md".to_string(),
        ...
        SemanticEvidence {
            ...
            confidence: Confidence::SourceBacked,
            source: "F:\\Realmz Scenario Utility\\docs\\scenario-format\\containers\\supporting-records.md".to_string(),
