...
function canonicalTargetRecord<K extends TargetCollectionName>(collection: K, record: Project[K][number]) {
  if (collection !== "messages" && collection !== "battles" && collection !== "monsters" && collection !== "scenarioItems" && collection !== "treasures" && collection !== "shops" && collection !== "simpleEncounters" && collection !== "complexEncounters" && collection !== "thiefEncounters") return record;
