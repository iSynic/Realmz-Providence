...
export const DOOR_BYTES = REALMZ_NATIVE_LAYOUT.actionPointRecordBytes;
...
export const SPELL_OVERRIDE_RECORDS = REALMZ_NATIVE_LAYOUT.spellOverrideRecords;
export const RACE_BYTES = REALMZ_NATIVE_LAYOUT.raceRecordBytes;
export const CASTE_BYTES = REALMZ_NATIVE_LAYOUT.casteRecordBytes;
...
const RECORD_BYTES: Record<string, number> = {
  ...
  "Data CI": REALMZ_NATIVE_LAYOUT.scenarioContactInfoBytes,
  "Data RI": REALMZ_NATIVE_LAYOUT.scenarioRestrictionsBytes,
