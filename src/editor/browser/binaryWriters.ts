...
export const ITEM_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.scenarioItemRecordBytes;
export const TREASURE_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.treasureRecordBytes;
export const SHOP_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.shopRecordBytes;
export const SPELL_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.spellRecordBytes;
export const RACE_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.raceRecordBytes;
export const CASTE_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.casteRecordBytes;
export const SIMPLE_ENCOUNTER_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.simpleEncounterRecordBytes;
export const COMPLEX_ENCOUNTER_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.complexEncounterRecordBytes;
export const THIEF_ENCOUNTER_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.thiefEncounterRecordBytes;
export const TIMED_ENCOUNTER_RECORD_BYTES = REALMZ_NATIVE_LAYOUT.timedEncounterRecordBytes;
...
export const MAP_RECORD_MARKERS = REALMZ_NATIVE_LAYOUT.mapRecordMarkers;
export const MAP_RECORD_MARKER_BYTES = REALMZ_NATIVE_LAYOUT.mapRecordMarkerBytes;
