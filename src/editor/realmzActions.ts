...
const ACTION_DETAILS: Record<number, Partial<RealmzActionOption>> = {
  ...
  7: { shortLabel: "Patch Actions", category: "Branch", description: "Replace another Action Point or encounter result script with codes stored in an Extra Action Point.", edcdShape: "action-data-patching" },
  ...
  25: { shortLabel: "Exit/Delete AP", category: "Branch", description: "Stop this script and delete or disable the current Action Point after it fires." },
  26: { shortLabel: "Get Click", category: "Branch", description: "Wait for or capture a player click for following action behavior." },
  27: { shortLabel: "Picture", category: "Media", description: "Show a PICT resource." },
  28: { shortLabel: "Redraw", category: "Media", description: "Force Realmz to redraw the game screen." },
  ...
  32: { shortLabel: "Temple", category: "Economy", description: "Offer temple services using the ID value as the temple inflation rate." },
  ...
  44: { shortLabel: "Eliminate Choice", category: "Encounter", description: "Eliminate a branch from a complex encounter choice." },
  ...
  66: { shortLabel: "Camping", category: "Scenario", description: "Control whether the party can camp." },
  ...
  88: { shortLabel: "Drop Special", category: "Characters", description: "Remove a special character from the party." },
  89: { shortLabel: "Add Special", category: "Characters", description: "Add a special character to the party." },
  ...
  91: { shortLabel: "Drop Equipment", category: "Economy", description: "Drop all party equipment." },
  ...
  93: { shortLabel: "Compass On", category: "Map", description: "Enable the compass display." },
  94: { shortLabel: "Compass Off", category: "Map", description: "Disable the compass display." },
  95: { shortLabel: "Look Direction", category: "Map", description: "Force the party to face a direction." },
  96: { shortLabel: "3D View", category: "Map", description: "Force the party to use the 3D view while in dungeons." },
  97: { shortLabel: "Map Record", category: "Map", description: "Use or reference map record data." },
  98: { shortLabel: "Require Reg", category: "Scenario", description: "Run a legacy registration requirement check." },
  99: { shortLabel: "Get Registration", category: "Scenario", description: "Run the legacy scenario registration gate." },
  100: { shortLabel: "End Battle", category: "Combat", description: "End the current battle." },
  101: { shortLabel: "Back Up Party", category: "Map", description: "Move the party back one square opposite the direction they entered from." },
  102: { shortLabel: "Level Up", category: "Characters", description: "Level up the currently picked characters." },
  ...
  105: { shortLabel: "Allies", category: "Characters", description: "Suspend or activate allies." },
  ...
  127: { shortLabel: "Monster Present", category: "Combat", description: "Continue monster or battle macro behavior if a matching monster is present." }
};
