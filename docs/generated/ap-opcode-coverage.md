...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| -23 | covered-in-current-ui | source-backed | Alter Random Rectangle Information of a Land Level | Extra Codes ID | Land Level ID; Rectangle Number To Alter; New X ‘s In 10,000; New Battle Range Low -> battle; New Battle Range High -> battle | Data EDCD | 23 |  |
