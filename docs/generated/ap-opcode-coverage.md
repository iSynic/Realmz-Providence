...
- ignored-empty: 1
- not-used-no-dispatch: 11
- preserved-but-known: 1

## Coverage

| Opcode | Status | Title | Storage | Shape |
| ---: | --- | --- | --- | --- |
...
| 79 | not-used-no-dispatch | Not Used | direct-id |  |
| 80 | not-used-no-dispatch | Not Used | direct-id |  |
...
| 84 | not-used-no-dispatch | Not Used | direct-id |  |
...
| 109 | not-used-no-dispatch | Not Used | direct-id |  |
| 110 | not-used-no-dispatch | Not Used | direct-id |  |
| 111 | authorable-now | Return From Gosub | direct-id |  |
| 112 | authorable-now | POP The Stack | direct-id |  |
| 113 | not-used-no-dispatch | Not Used | direct-id |  |
| 114 | not-used-no-dispatch | Not Used | direct-id |  |
| 115 | not-used-no-dispatch | Not Used | direct-id |  |
| 116 | not-used-no-dispatch | Not Used | direct-id |  |
| 117 | not-used-no-dispatch | Not Used | direct-id |  |
| 118 | not-used-no-dispatch | Not Used | direct-id |  |
...
| 121 | preserved-but-known | De-animate Lower Undead (Monster & Battle Macros Only) | Data EDCD | unused-edcd-load |
