...
| 0 | intentionally-preserved | catalog-only | Empty | ID | Step only | direct-id |  |  |  |
...
| 62 | covered-in-current-ui | manual-backed | Display Scrolling Text | Text ID To Display | Scrolling Text -> text-resource | direct-id |  |  |  |
