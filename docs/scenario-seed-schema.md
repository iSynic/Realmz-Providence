...
- Map operations: `fill`, `rect`, `line`, `path`, `border`, `room`, `castleRoom`, `road`, `river`, `semanticRoad`, `semanticRoute`, `stamp`, `namedStamp`, `namedTile`, `terrainGroup`, `landmass`, `landSecret`, `hiddenWalkable`, `combatClearing`, and `dungeonPassage`.
