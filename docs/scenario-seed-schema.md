...
- Map operations: `fill`, `rect`, `line`, `path`, `border`, `room`, `road`, `river`, `stamp`, `terrainGroup`, `landSecret`, `hiddenWalkable`, `combatClearing`, and `dungeonPassage`.
