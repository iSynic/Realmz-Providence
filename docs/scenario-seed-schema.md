...
- Map operations: `fill`, `rect`, `line`, `path`, `border`, `room`, `road`, `river`, `stamp`, `namedTile`, `terrainGroup`, `landSecret`, `hiddenWalkable`, `combatClearing`, and `dungeonPassage`.
