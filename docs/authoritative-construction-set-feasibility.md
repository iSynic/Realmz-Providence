...
- full Rust suite: 190 passed, 2 ignored;
...
2. **Optional resource families:** the minimum empty main fork and fresh item-string fork are
   generated in both compilers, but custom spell strings and other optional resource families
   remain incomplete.
...
8. **Optional feature debt:** custom spell names, custom music, and some extracted resource-sidecar
   forms need production decisions after the minimum proof.
...
- Generate custom spell resources in both runtimes; keep the completed item-string path in the
