...
- Replace raw dungeon paint options with named primitives: wall, door, stair, pillar, directional secret/pass-through, hidden visual, revealed marker, note marker, and Action Point trigger marker.
