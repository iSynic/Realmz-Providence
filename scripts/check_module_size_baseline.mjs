...
const MODULE_BASELINES = [
  ...
  { path: "src/editor/components/maps/MapTileInspector.tsx", maximum: 135, owner: "ISY-319/ISY-393" },
  { path: "src/editor/components/maps/MapSelectionLinks.tsx", maximum: 86, owner: "ISY-319" },
  { path: "src/editor/components/maps/mapSelectionModel.ts", maximum: 79, owner: "ISY-319/ISY-393" },
  ...
  { path: "src/editor/styles/script-navigation.css", maximum: 90, owner: "ISY-393" },
  { path: "src/editor/styles/map-context-sidebar.css", maximum: 1189, owner: "ISY-321" },
  { path: "src/editor/styles/map-selection-controls.css", maximum: 40, owner: "ISY-393" },
  ...
  { path: "src/editor/styles/map-tile-palette.css", maximum: 735, owner: "ISY-321/ISY-393" },
  ...
  { path: "src/editor/styles/map-section-navigation.css", maximum: 58, owner: "ISY-393" },
  ...
  { path: "src/editor/styles/asset-preview-controls.css", maximum: 66, owner: "ISY-393" },
  { path: "src/editor/styles/asset-reference-icon-dialog.css", maximum: 85, owner: "ISY-393" },
