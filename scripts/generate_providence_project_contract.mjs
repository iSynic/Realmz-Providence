...
const treasureFields = ["id", "itemIds", "exp", "gold", "gems", "jewelry", "authored", "provenance"];
expectSameArray(Object.keys(treasureRecordSchema.properties ?? {}), treasureFields, "Treasure field inventory");
expectSameArray(treasureRecordSchema.required ?? [], treasureFields.filter((field) => field !== "authored"), "Treasure authored field inventory");
...
expectSameArray(treasureRecordSchema["x-providence-rust-default"] ?? [], ["itemIds", "authored"], "Treasure Rust default inventory");
const shopFields = ["id", "itemIds", "quantities", "inflation", "authored", "provenance"];
expectSameArray(Object.keys(shopRecordSchema.properties ?? {}), shopFields, "Shop field inventory");
expectSameArray(shopRecordSchema.required ?? [], shopFields.filter((field) => field !== "authored"), "Shop authored field inventory");
...
expectSameArray(shopRecordSchema["x-providence-rust-default"] ?? [], ["itemIds", "quantities", "authored"], "Shop Rust default inventory");
const messageFields = ["id", "text", "authored", "provenance"];
...
const battleFields = ["id", "grid", "dist", "messageBefore", "messageAfter", "battleMacro", "authored", "provenance"];
expectSameArray(Object.keys(battleRecordSchema.properties ?? {}), battleFields, "Battle field inventory");
expectSameArray(battleRecordSchema.required ?? [], battleFields.filter((field) => field !== "authored"), "Battle authored field inventory");
...
expectSameArray(simpleEncounterRecordSchema.required ?? [], simpleEncounterFields.filter((field) => field !== "authored"), "Simple-encounter authored field inventory");
...
expectSameArray(simpleEncounterRecordSchema["x-providence-rust-default"] ?? [], ["authored"], "Simple-encounter Rust default inventory");
const complexEncounterFields = ["id", "actions", "actionResult", "wordResult", "groups", "spellIds", "spellResults", "itemIds", "itemResults", "choiceResults", "wordResults", "canBackOut", "thief", "maxTimes", "casteSuccess", "thiefSuccess", "thiefFail", "prompt", "texts", "authored", "provenance"];
...
expectSameArray(complexEncounterRecordSchema.required ?? [], complexEncounterFields.filter((field) => !["choiceResults", "wordResults", "authored"].includes(field)), "Complex-encounter authored field inventory");
...
expectSameSet(recordCompatibilityFields, ["ScenarioRaceOverride.spare", "ScenarioRaceOverride.spacer", "ScenarioCasteOverride.spare1", "ScenarioCasteOverride.spare2", "ScenarioCasteOverride.spacer", "ScenarioCasteOverride.rawBytes"], "Record compatibility-only field inventory");
