...
const AUDIT_BY_PAGE = {
  ...
  11: audit({
    ...
    evidence: ["docs/generated/monster-record-evidence.json", "docs/generated/monster-description-set-evidence.json", "docs/format-evidence-cards/bestiary-source-alignment.md", "docs/format-evidence-cards/monster-descriptions-and-sets-runtime-anchors.md", "F:/Realmz/src/realmz_orig/structs.h"],
    gaps: ["Several manual labels and meanings remain uncertain: Req Weapon versus Weapon Used, attack row semantics, type flags, summon options, and runtime-looking fields.", "Providence Generate Variants needs broader authored-scenario smoke testing against exported Data MD1/Data MD-1.", "Exact Divinity Create Sets quirks remain intentionally deferred because Mega spell-point rounding, overflow/clamp behavior, and rel 7 / rel 45 persistence are not confidence-complete."],
    followUp: ["Run a Monster Editor field-by-field label audit with Divinity screenshots/fixtures.", "Add regression tests for set-aware editing, Copy Current To All Sets, Switch With, and Generate Variants.", "Keep exact Divinity Create Sets and ambiguous Req Weapon behavior fixture-gated unless a separate compatibility need appears."]
  }),
  12: audit({
    status: "partial",
